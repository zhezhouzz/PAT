...
let mk_return_void = (PReturn (PConst PUnit)#:Nt.unit_ty)#:Nt.unit_ty
...
let mk_p_halt = mk_return @@ ((PConst PHalt)#:Nt.unit_ty)
...
let mk_p_error = mk_return @@ ((PConst PError)#:Nt.unit_ty)
